...
def test_calculate_macro_metrics_binary():
    ...
    sklearn_recall_binary = recall_score(y_true_binary, y_pred_binary, average="macro")
    sklearn_f1_binary = f1_score(y_true_binary, y_pred_binary, average="macro")
    ...
    (
        ...
        your_f1_binary,
        your_jaccard_binary,
    ) = calculate_macro_metrics(y_true_binary, y_pred_binary)
...
def test_calculate_macro_metrics_multiclass():
    ...
    ) = calculate_macro_metrics(y_true_multiclass, y_pred_multiclass)
